...
__all__ = ["mixed_mix", "sparse_to_dense", "initial_voxelize", "point_to_voxel", "voxel_to_point", "PointTensor", "unique", 
...
def sparse_to_dense(x, b):
    """
    Receives a sparse representation and the batch idx for each element 
    Returns a dense sequence representation and a mask indicating the actual values
    """
